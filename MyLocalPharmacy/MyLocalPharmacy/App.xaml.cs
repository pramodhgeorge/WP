...
namespace MyLocalPharmacy
{
    public partial class App : Application
    {
        ...
        public static string resetLoginPIN;// = "pinValueNull";
        public static string resetLoginAuthCode;// = "authValueNill";

        //public static bool resetLoginIsValidated = ;
        ...
        public static GetPharmacyInformationResponse Objbrandingesponse;
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            //    Thread.Sleep(10000); //A little dummy delay for show the effect
            //};
